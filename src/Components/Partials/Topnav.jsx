...
const Topnav = () => {
  ...
  useEffect(() => {
    if (debouncedQuery.trim()) {
      ...
      setsearches([]); // clear results when input is empty
    }
  }, [debouncedQuery]);

  return (
    <div className="h-[9vh] w-full flex justify-start items-center sm:pl-[15%] z-[99999] relative">
      <i className="text-4xl ri-search-line text-zinc-400 cursor-pointer hidden sm:block"></i>
     <div className="flex items-center justify-center gap-8">
      ...
      {searches.length > 0 && (
        <div className="fixed top-[10%] sm:top-[10%] flex items-center justify-center z-10 left-0 md:left-[35%] mb-44">
          <div className="w-[100%] sm:w-[100%] max-h-[50vh] bg-zinc-200 overflow-auto rounded shadow-lg">
            {searches.map((s, i) => (
              <Link
