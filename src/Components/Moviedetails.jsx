...
const Moviedetails = () => {
  ...
  return info ? (
    <div
      className="relative w-screen h-max px-[5%] overflow-hidden"
      style={{
    ...
    >
      {/* Part 1 nav */}
      <nav className="h-[10vh] w-full text-zinc-100 flex gap-4 sm:gap-10 items-center "> 
        <Link
          onClick={() => navigate(-1)}
      ...
      <div className="w-full flex flex-col sm:flex-row">
        ...
        />
         ...
         <div className="content sm:ml-16 flex flex-col gap-3 text-white w-full mt-10 sm:mt-0">
          ...
          <div className="flex items-center gap-[4vw]">
            ...
            <h1 className="mt-3 text-xl">{info.detail.release_date}</h1>
            <h1 className="mt-3 text-xl">{info.detail.genres.map((g)=>g.name).join(", ")}</h1>
            <h1 className="mt-3 text-xl">{info.detail.runtime}Min</h1>
          </div>
          ...
          <h1 className="w-[90%] sm:w-full">Available in: {info.translations.join(", ")}</h1>
